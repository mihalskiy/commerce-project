...
import avatar from '../images/about.gif';
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          ...
          <Subtitle>Мы команда профессионалов, жаждущих и мотивированных к новым проектам</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          <Title>ПОЧЕМУ МЫ ЛУЧШИЕ?</Title>
          <AboutHero>
            <Avatar src={avatar} alt="John Doe" />
            <AboutSub>
              Профессиональные дизайнеры в программах, которые известны очень узкому кругу специалистов, разработают уникальный вкусный дизайн вашего предложения.
            </AboutSub>
          </AboutHero>
          <AboutDesc>
            Приезжаем в магазины клиента, звоним конкурентам, фотографируем офисы, проводим разведку, ищем аналоги, формируем фокус-группы, общаемся на форумах с потребителями.
          </AboutDesc>
        </Inner>
      </Content>
